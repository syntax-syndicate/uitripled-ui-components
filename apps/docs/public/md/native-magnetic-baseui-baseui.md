...
import { NativeMagnetic } from "components/native/baseui/native-magnetic-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-magnetic-baseui-baseui
```
...
<ComponentSource name="native-magnetic-baseui-baseui" title="components/native/baseui/native-magnetic-baseui.tsx" />
