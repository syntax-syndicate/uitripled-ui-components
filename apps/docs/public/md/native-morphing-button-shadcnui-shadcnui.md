...
import { NativeMorphingButton } from "components/native/shadcnui/native-morphing-button-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-morphing-button-shadcnui-shadcnui
```
...
<ComponentSource name="native-morphing-button-shadcnui-shadcnui" title="components/native/shadcnui/native-morphing-button-shadcnui.tsx" />
