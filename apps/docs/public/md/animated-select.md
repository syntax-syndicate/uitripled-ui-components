...
import { AnimatedSelect } from "@/components/forms/animated-select.tsx";
...
```bash
npx shadcn@latest add @uitripled/animated-select
```
...
<ComponentSource name="animated-select" title="@/components/forms/animated-select.tsx" />
