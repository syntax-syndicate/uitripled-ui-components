...
import { AnimatedCheckbox } from "@/components/forms/animated-checkbox.tsx";
...
```bash
npx shadcn@latest add @uitripled/animated-checkbox
```
...
<ComponentSource name="animated-checkbox" title="@/components/forms/animated-checkbox.tsx" />
