...
```bash
npx shadcn@latest add @uitripled/native-button-shadcnui-shadcnui
```
...
<ComponentSource name="native-button-shadcnui-shadcnui" title="components/native/shadcnui/native-button-shadcnui.tsx" />
