...
import { NativeTypewriter } from "components/native/baseui/native-typewriter-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-typewriter-baseui-baseui
```
...
The `Native Typewriter` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-typewriter-baseui-baseui" title="components/native/baseui/native-typewriter-baseui.tsx" />
