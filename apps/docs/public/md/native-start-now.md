...
import { NativeStartNow } from "@uitripled/react-shadcn/src/components/native/native-start-now-shadcnui.tsx"
...
```bash
npx shadcn@latest add @uitripled/native-start-now
```
...
<ComponentSource name="native-start-now" title="@uitripled/react-shadcn/src/components/native/native-start-now-shadcnui.tsx" />
