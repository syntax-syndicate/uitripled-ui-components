...
import { NativeHoverCard } from "components/native/shadcnui/native-hover-card-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-hover-card-shadcnui-shadcnui
```
...
<ComponentSource name="native-hover-card-shadcnui-shadcnui" title="components/native/shadcnui/native-hover-card-shadcnui.tsx" />
