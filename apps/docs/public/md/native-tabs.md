...
```bash
npx shadcn@latest add @uitripled/native-tabs
```
...
<ComponentSource name="native-tabs" title="@uitripled/react-shadcn/src/components/native/native-tabs-shadcnui.tsx" />
