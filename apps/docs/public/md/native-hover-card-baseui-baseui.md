...
import { NativeHoverCard } from "components/native/baseui/native-hover-card-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-hover-card-baseui-baseui
```
...
The `Native Hover Card` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-hover-card-baseui-baseui" title="components/native/baseui/native-hover-card-baseui.tsx" />
