...
import { NativeDialog } from "components/native/baseui/native-dialog-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-dialog-baseui-baseui
```
...
The `Native Dialog` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-dialog-baseui-baseui" title="components/native/baseui/native-dialog-baseui.tsx" />
