...
```bash
npx shadcn@latest add @uitripled/native-tooltip-baseui-baseui
```
...
<ComponentSource name="native-tooltip-baseui-baseui" title="components/native/baseui/native-tooltip-baseui.tsx" />
