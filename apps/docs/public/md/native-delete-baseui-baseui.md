...
import { NativeDelete } from "components/native/baseui/native-delete-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-delete-baseui-baseui
```
...
<ComponentSource name="native-delete-baseui-baseui" title="components/native/baseui/native-delete-baseui.tsx" />
