---
title: Magnetic Cursor Link
description: Link that slightly follows mouse cursor within boundary and snaps back
component: true
---
...
import { MagneticCursorLink } from "@/components/motion-core/magnetic-cursor-link.tsx";

export function MagneticCursorLinkDemo() {
  return <MagneticCursorLink />;
}
```
...
```bash
npx shadcn@latest add @uitripled/magnetic-cursor-link
```
...
<ComponentSource name="magnetic-cursor-link" title="@/components/motion-core/magnetic-cursor-link.tsx" />
