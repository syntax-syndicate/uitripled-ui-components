...
```bash
npx shadcn@latest add @uitripled/native-magnetic-shadcnui-shadcnui
```
...
<ComponentSource name="native-magnetic-shadcnui-shadcnui" title="components/native/shadcnui/native-magnetic-shadcnui.tsx" />
