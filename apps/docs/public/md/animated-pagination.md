...
import { AnimatedPagination } from "@/components/navigation/animated-pagination.tsx";

export function AnimatedPaginationDemo() {
  return <AnimatedPagination />;
}
```
...
```bash
npx shadcn@latest add @uitripled/animated-pagination
```
...
<ComponentSource name="animated-pagination" title="@/components/navigation/animated-pagination.tsx" />
