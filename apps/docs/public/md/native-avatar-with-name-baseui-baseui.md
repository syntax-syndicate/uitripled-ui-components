...
```bash
npx shadcn@latest add @uitripled/native-avatar-with-name-baseui-baseui
```
...
<ComponentSource name="native-avatar-with-name-baseui-baseui" title="components/native/baseui/native-avatar-with-name-baseui.tsx" />
