...
export function GlassmorphismTestimonialsDemo() {
  return <GlassmorphismTestimonials />;
}
```
...
```bash
npx shadcn@latest add @uitripled/glassmorphism-testimonials-block
```
...
- **Category**: blocks
- **Tags**: testimonials, reviews, glassmorphism, cards, ratings, shadcn
