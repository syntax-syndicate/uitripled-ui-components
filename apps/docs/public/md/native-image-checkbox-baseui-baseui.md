...
import { NativeImageCheckbox } from "components/native/baseui/native-image-checkbox-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-image-checkbox-baseui-baseui
```
...
<ComponentSource name="native-image-checkbox-baseui-baseui" title="components/native/baseui/native-image-checkbox-baseui.tsx" />
