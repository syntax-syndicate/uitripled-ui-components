...
```bash
npx shadcn@latest add @uitripled/native-notification-bell-shadcnui-shadcnui
```
...
<ComponentSource name="native-notification-bell-shadcnui-shadcnui" title="components/native/shadcnui/native-notification-bell-shadcnui.tsx" />
