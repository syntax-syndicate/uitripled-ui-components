...
```bash
npx shadcn@latest add @uitripled/native-liquid-button-shadcnui-shadcnui
```
...
<ComponentSource name="native-liquid-button-shadcnui-shadcnui" title="components/native/shadcnui/native-liquid-button-shadcnui.tsx" />
