...
import { Fade&SlideModal } from "@/components/components/modal/fade-slide.tsx"
...
```bash
npx shadcn@latest add @uitripled/fade-slide-modal
```
...
<ComponentSource name="fade-slide-modal" title="@/components/components/modal/fade-slide.tsx" />
