...
```bash
npx shadcn@latest add @uitripled/social-login-button-baseui-baseui
```
...
<ComponentSource name="social-login-button-baseui-baseui" title="components/native/baseui/social-login-button-baseui.tsx" />
