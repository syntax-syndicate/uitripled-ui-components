...
import { LiquidCursor } from "@/components/liquid-cursor.tsx";
...
```bash
npx shadcn@latest add @uitripled/liquid-cursor
```
...
<ComponentSource name="liquid-cursor" title="@/components/liquid-cursor.tsx" />
