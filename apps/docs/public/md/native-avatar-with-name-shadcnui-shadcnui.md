...
```bash
npx shadcn@latest add @uitripled/native-avatar-with-name-shadcnui-shadcnui
```
...
<ComponentSource name="native-avatar-with-name-shadcnui-shadcnui" title="components/native/shadcnui/native-avatar-with-name-shadcnui.tsx" />
