...
```bash
npx shadcn@latest add @uitripled/native-avatar-expand-shadcnui-shadcnui
```
...
<ComponentSource name="native-avatar-expand-shadcnui-shadcnui" title="components/native/shadcnui/native-avatar-expand-shadcnui.tsx" />
