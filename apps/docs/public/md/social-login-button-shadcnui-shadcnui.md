...
```bash
npx shadcn@latest add @uitripled/social-login-button-shadcnui-shadcnui
```
...
<ComponentSource name="social-login-button-shadcnui-shadcnui" title="components/native/shadcnui/social-login-button-shadcnui.tsx" />
