...
import { AnimatedRadio } from "@/components/forms/animated-radio.tsx";
...
```bash
npx shadcn@latest add @uitripled/animated-radio
```
...
<ComponentSource name="animated-radio" title="@/components/forms/animated-radio.tsx" />
