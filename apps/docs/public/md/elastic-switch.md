...
import { ElasticToggleSwitch } from "@/components/micro/toggles/elastic-switch.tsx";

export function ElasticToggleSwitchDemo() {
  return <ElasticToggleSwitch />;
}
```
...
<ComponentSource name="elastic-switch" title="@/components/micro/toggles/elastic-switch.tsx" />
