...
import { GlassmorphismProductUpdates } from "@/components/sections/shadcnui/glassmorphism-product-update-block.tsx";
...
```bash
npx shadcn@latest add @uitripled/glassmorphism-product-update-block
```
...
<ComponentSource name="glassmorphism-product-update-block" title="@/components/sections/shadcnui/glassmorphism-product-update-block.tsx" />
