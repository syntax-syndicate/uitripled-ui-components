...
import { SocialLoginButton } from "@uitripled/react-shadcn/src/components/native/social-login-button-shadcnui.tsx"
...
```bash
npx shadcn@latest add @uitripled/social-login-button
```
...
<ComponentSource name="social-login-button" title="@uitripled/react-shadcn/src/components/native/social-login-button-shadcnui.tsx" />
