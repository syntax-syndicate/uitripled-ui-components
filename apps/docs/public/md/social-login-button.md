...
import { SocialLoginButton } from "@uitripled/react-shadcn/components/native/social-login-button-shadcnui.tsx"
...
<ComponentSource name="social-login-button" title="@uitripled/react-shadcn/components/native/social-login-button-shadcnui.tsx" />
