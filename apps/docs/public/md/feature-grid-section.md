...
```bash
npx shadcn@latest add @uitripled/feature-grid-section
```
...
The `Feature Grid Section` component uses the following components. Make sure you have them installed in your project.
