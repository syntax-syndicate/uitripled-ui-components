...
```bash
npx shadcn@latest add @uitripled/native-notch
```
...
<ComponentSource name="native-notch" title="@uitripled/react-shadcn/src/components/native/native-notch-shadcnui.tsx" />
