...
```bash
npx shadcn@latest add @uitripled/native-liquid-button
```
...
<ComponentSource name="native-liquid-button" title="@uitripled/react-shadcn/src/components/native/native-liquid-button-shadcnui.tsx" />
