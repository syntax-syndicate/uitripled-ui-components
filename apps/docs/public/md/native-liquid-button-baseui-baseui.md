...
import { NativeLiquidButton } from "components/native/baseui/native-liquid-button-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-liquid-button-baseui-baseui
```
...
The `Native Liquid Button` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-liquid-button-baseui-baseui" title="components/native/baseui/native-liquid-button-baseui.tsx" />
