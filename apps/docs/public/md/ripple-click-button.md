...
import { RippleClickEffect } from "@/components/micro/buttons/ripple-click.tsx";
...
```bash
npx shadcn@latest add @uitripled/ripple-click-button
```
...
<ComponentSource name="ripple-click-button" title="@/components/micro/buttons/ripple-click.tsx" />
