...
```bash
npx shadcn@latest add @uitripled/toast-notification
```
...
The `Toast Notification` component uses the following components. Make sure you have them installed in your project.
...
<ComponentSource name="toast-notification" title="@/components/page/notifications/toast-notification.tsx" />
