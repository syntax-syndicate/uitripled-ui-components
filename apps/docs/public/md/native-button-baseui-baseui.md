...
```bash
npx shadcn@latest add @uitripled/native-button-baseui-baseui
```
...
<ComponentSource name="native-button-baseui-baseui" title="components/native/baseui/native-button-baseui.tsx" />
