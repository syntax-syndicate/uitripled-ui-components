...
import { NativeImageCheckbox } from "components/native/shadcnui/native-image-checkbox-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-image-checkbox-shadcnui-shadcnui
```
...
<ComponentSource name="native-image-checkbox-shadcnui-shadcnui" title="components/native/shadcnui/native-image-checkbox-shadcnui.tsx" />
