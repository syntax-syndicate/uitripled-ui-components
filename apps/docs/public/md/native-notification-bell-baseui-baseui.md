...
import { NativeNotificationBell } from "components/native/baseui/native-notification-bell-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-notification-bell-baseui-baseui
```
...
<ComponentSource name="native-notification-bell-baseui-baseui" title="components/native/baseui/native-notification-bell-baseui.tsx" />
