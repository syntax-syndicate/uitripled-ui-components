...
import { NativeDialog } from "components/native/shadcnui/native-dialog-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-dialog-shadcnui-shadcnui
```
...
<ComponentSource name="native-dialog-shadcnui-shadcnui" title="components/native/shadcnui/native-dialog-shadcnui.tsx" />
