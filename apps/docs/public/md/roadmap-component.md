...
description: Interactive learning path with modules, resources, progress tracking, and vertical timeline
component: true
---
...
import { LearningRoadmap } from "@/components/components/roadmap/roadmap-component.tsx";

export function LearningRoadmapDemo() {
...
```bash
npx shadcn@latest add @uitripled/roadmap-component
```
...
The `Learning Roadmap` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="roadmap-component" title="@/components/components/roadmap/roadmap-component.tsx" />
...
- **Category**: components
- **Tags**: roadmap, learning, timeline, education, course
