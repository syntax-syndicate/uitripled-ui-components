...
```bash
npx shadcn@latest add @uitripled/magnetic-button
```
...
The `Magnetic Button` component uses the following components. Make sure you have them installed in your project.
