...
import { StaggeredDropdown } from "@/components/components/dropdown/staggered-items.tsx";
...
```bash
npx shadcn@latest add @uitripled/staggered-dropdown
```
...
<ComponentSource name="staggered-dropdown" title="@/components/components/dropdown/staggered-items.tsx" />
