...
import { NativeTooltip } from "components/native/shadcnui/native-tooltip-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-tooltip-shadcnui-shadcnui
```
...
<ComponentSource name="native-tooltip-shadcnui-shadcnui" title="components/native/shadcnui/native-tooltip-shadcnui.tsx" />
