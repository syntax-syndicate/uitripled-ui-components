...
import { NativeHoverCard } from "@uitripled/react-shadcn/components/native/native-hover-card-shadcnui.tsx"
...
```bash
npx shadcn@latest add @uitripled/native-hover-card
```
...
<ComponentSource name="native-hover-card" title="@uitripled/react-shadcn/components/native/native-hover-card-shadcnui.tsx" />
