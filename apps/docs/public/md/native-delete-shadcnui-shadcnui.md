...
import { NativeDelete } from "components/native/shadcnui/native-delete-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-delete-shadcnui-shadcnui
```
...
<ComponentSource name="native-delete-shadcnui-shadcnui" title="components/native/shadcnui/native-delete-shadcnui.tsx" />
