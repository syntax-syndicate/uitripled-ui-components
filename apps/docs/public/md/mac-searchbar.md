...
import { MacSearchbar } from "@/components/search/mac-searchbar.tsx";
...
```bash
npx shadcn@latest add @uitripled/mac-searchbar
```
...
<ComponentSource name="mac-searchbar" title="@/components/search/mac-searchbar.tsx" />
...
- **Category**: components
- **Tags**: search, mac, dropdown, glassmorphism, animated, framer-motion
