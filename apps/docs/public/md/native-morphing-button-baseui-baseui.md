...
import { NativeMorphingButton } from "components/native/baseui/native-morphing-button-baseui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-morphing-button-baseui-baseui
```
...
<ComponentSource name="native-morphing-button-baseui-baseui" title="components/native/baseui/native-morphing-button-baseui.tsx" />
