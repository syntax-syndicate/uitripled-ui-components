---
title: Smart Tabs
description: Animated tabs with sliding pill indicator and smooth content transitions
component: true
---
...
import { SmartTabs } from "@/components/components/tabs/smart-tabs.tsx";
...
```bash
npx shadcn@latest add @uitripled/smart-tabs
```
...
The `Smart Tabs` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="smart-tabs" title="@/components/components/tabs/smart-tabs.tsx" />
