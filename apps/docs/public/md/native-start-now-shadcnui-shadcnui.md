...
import { NativeStartNow } from "components/native/shadcnui/native-start-now-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-start-now-shadcnui-shadcnui
```
...
<ComponentSource name="native-start-now-shadcnui-shadcnui" title="components/native/shadcnui/native-start-now-shadcnui.tsx" />
