...
import { NativeTabs } from "components/native/shadcnui/native-tabs-shadcnui.tsx";
...
```bash
npx shadcn@latest add @uitripled/native-tabs-shadcnui-shadcnui
```
...
<ComponentSource name="native-tabs-shadcnui-shadcnui" title="components/native/shadcnui/native-tabs-shadcnui.tsx" />
