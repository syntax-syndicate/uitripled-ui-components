...
import { AnimatedTabs } from "@/components/components/tabs/animated-tabs.tsx"
...
```bash
npx shadcn@latest add @uitripled/animated-tabs
```
...
<ComponentSource name="animated-tabs" title="@/components/components/tabs/animated-tabs.tsx" />
