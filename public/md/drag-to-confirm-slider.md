...
import { Drag-to-ConfirmSlider } from "@/components/motion-core/drag-to-confirm-slider.tsx"
...
```bash
npx shadcn@latest add @uitripled/drag-to-confirm-slider
```
...
<ComponentSource name="drag-to-confirm-slider" title="@/components/motion-core/drag-to-confirm-slider.tsx" />
