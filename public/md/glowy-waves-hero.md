...
import { GlowyWavesHero } from "@/components/sections/glowy-waves-hero.tsx"
...
```bash
npx shadcn@latest add @uitripled/glowy-waves-hero
```
...
The `Glowy Waves Hero` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="glowy-waves-hero" title="@/components/sections/glowy-waves-hero.tsx" />
