...
```bash
npx shadcn@latest add @uitripled/morphing-action-button
```
...
<ComponentSource name="morphing-action-button" title="@/components/motion-core/morphing-action-button.tsx" />
