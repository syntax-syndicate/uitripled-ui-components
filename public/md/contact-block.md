...
import { ContactBlock } from "@/components/sections/contact-block.tsx"
...
```bash
npx shadcn@latest add @uitripled/contact-block
```
...
<ComponentSource name="contact-block" title="@/components/sections/contact-block.tsx" />
