...
import { Auto-RevealingHeading } from "@/components/motion-core/auto-revealing-heading.tsx"
...
```bash
npx shadcn@latest add @uitripled/auto-revealing-heading
```
...
<ComponentSource name="auto-revealing-heading" title="@/components/motion-core/auto-revealing-heading.tsx" />
