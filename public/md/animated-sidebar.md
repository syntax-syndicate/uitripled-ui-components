...
import { AnimatedSidebar } from "@/components/navigation/animated-sidebar.tsx"
...
```bash
npx shadcn@latest add @uitripled/animated-sidebar
```
...
<ComponentSource name="animated-sidebar" title="@/components/navigation/animated-sidebar.tsx" />
