...
```bash
npx shadcn@latest add @uitripled/reactive-background-grid
```
...
<ComponentSource name="reactive-background-grid" title="@/components/motion-core/reactive-background-grid.tsx" />
