...
import { AvatarGroup } from "@/components/avatars/avatar-group.tsx"
...
```bash
npx shadcn@latest add @uitripled/avatar-group
```
...
<ComponentSource name="avatar-group" title="@/components/avatars/avatar-group.tsx" />
