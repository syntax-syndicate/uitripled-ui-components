...
import { SpotlightSection } from "@/components/motion-core/spotlight-section.tsx"
...
```bash
npx shadcn@latest add @uitripled/spotlight-section
```
...
<ComponentSource name="spotlight-section" title="@/components/motion-core/spotlight-section.tsx" />
