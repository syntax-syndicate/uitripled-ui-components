...
import { HeartFavorite } from "@/components/micro/icons/heart-favorite.tsx"
...
```bash
npx shadcn@latest add @uitripled/heart-favorite
```
...
<ComponentSource name="heart-favorite" title="@/components/micro/icons/heart-favorite.tsx" />
