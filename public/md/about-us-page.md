...
```bash
npx shadcn@latest add @uitripled/about-us-page
```
...
The `About Us Page` component uses the following components. Make sure you have them installed in your project.
...
<ComponentSource name="about-us-page" title="@/components/page/about/about-us-page.tsx" />
