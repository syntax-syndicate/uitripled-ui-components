...
import { TypewriterEffect } from "@/components/decorative/text/typewriter.tsx"
...
```bash
npx shadcn@latest add @uitripled/typewriter-text
```
...
<ComponentSource name="typewriter-text" title="@/components/decorative/text/typewriter.tsx" />
