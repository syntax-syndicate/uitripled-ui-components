...
import { FloatingLabelInput } from "@/components/components/inputs/floating-label-input.tsx"
...
```bash
npx shadcn@latest add @uitripled/floating-label-input
```
...
<ComponentSource name="floating-label-input" title="@/components/components/inputs/floating-label-input.tsx" />
