...
import { AnimatedProgressBar } from "@/components/data/progress/animated-progress.tsx"
...
```bash
npx shadcn@latest add @uitripled/animated-progress
```
...
The `Animated Progress Bar` component uses the following components. Make sure you have them installed in your project.

- card

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="animated-progress" title="@/components/data/progress/animated-progress.tsx" />
